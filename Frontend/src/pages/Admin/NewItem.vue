    ...
    <div class="container">
      ...
      <div class="row">
          ...
          <!-- <el-form ref="form" :model="form" label-width="95px"> -->
            <Card>
              ...
              <el-form-item
                label="Name"
                :rules="[
                  { required: true, message: 'Item name cannot be empty' },
                ]"
              >
              ...
              <el-form-item label="Item Image (currently not linked yet)">
                ...
                >
                  ...
                  <div class="el-upload__text">
                    Drag File overhere, or <em>Click to upload</em>
                    <br />jpg/png file only and no more than 500kb
                  </div>
              ...
              <el-form-item
                ...
                :rules="[
                  ...
                  { type: 'number', message: 'cost must be number' },
                ]"
              >
                <el-input
              ...
              <el-form-item
                ...
                :rules="[
                  ...
                  { type: 'number', message: 'price must be number' },
                ]"
              >
                <el-input
        ...
        <div class="col">
          <!-- <el-form ref="form" :model="form"> -->
            <Card>
              ...
              <el-form-item
                ...
                prop="weight"
                :rules="[
                  { required: true, message: 'weight cannot be empty' },
                  { type: 'number', message: 'weight must be number' },
                ]"
              >
                <el-input
          ...
          <el-button type="primary" @click="postItem"> Publish Item to WareHouse </el-button>
...
export default {
  ...
  methods: {
    ...
    postItem(){
      Axios.post(WareHouseUrl, this.form).then((res) =>
      console.log(res),
